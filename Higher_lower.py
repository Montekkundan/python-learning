...
while contine_game:
    ...
    while account1 == account2:
        account2 = random.choice(data)
    print(f"Compare A: {formatted(account1)}")
    print(vs)
    print(f"Compare B: {formatted(account2)}")
    continue_play = True
    while continue_play:
    ...
    correct_choice = answer_check(guess, follower_count1, follower_count2)
    if correct_choice:
        score += 1
